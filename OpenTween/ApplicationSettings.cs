...
namespace OpenTween
{
    ...
    internal static class ApplicationSettings
    {
        ...
        /// Twitter コンシューマーキー
        /// </summary>
        public const string TwitterConsumerKey = "u5DJQYLDehjhNgq9RtRTfyNtu";
        public const string TwitterConsumerSecret = "U1waY3dpWAGrlxngxBiIGbxvxVQabAhUVsdllAdocHJlzFJAY6";
